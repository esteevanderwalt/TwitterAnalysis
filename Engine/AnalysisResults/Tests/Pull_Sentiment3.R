...
fetch <- function(idx, i) {
  ...
  sqltable <- "TWITTER.ZZ_TWEETS_WITH_ROWNUM"
  ...
  write.table(ff, file = paste("TweetSentiment",".csv",sep=""),na="",col.names=FALSE, sep=";", append=TRUE)
...
#set initial number of tweets to investigate
tweets <- 365170428
increments <- 1000
